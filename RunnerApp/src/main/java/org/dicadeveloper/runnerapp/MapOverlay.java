...
import org.dicadeveloper.runnerapp.maps.TrackPath;
import org.dicadeveloper.runnerapp.maps.TrackPathFactory;
...
import static org.dicadeveloper.runnerapp.content.TrackDataHub.TARGET_DISPLAYED_TRACK_POINTS;
...
public class MapOverlay {
   ...
   */
  public boolean update(IMap googleMap, ArrayList<Polyline> paths,
   ...
   * @return true if has the start marker
   */
  private boolean updateStartAndEndMarkers(IMap mMap) {
    // Add the end marker
    if (showEndMarker) {
   ...
   * @param googleMap the google map.
   */
  private void updateWaypoints(IMap googleMap) {
    synchronized (waypoints) {
